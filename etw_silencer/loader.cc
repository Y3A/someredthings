/*
    * By https://github.com/N4kedTurtle/ExecuteAssembly_Mailslot 
 */
...
extern "C" void invoke_dotnet(void)
{
    ...
    HANDLE hFile = CreateFileA("C:\\Users\\IEUser\\Desktop\\hello.exe", GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0, NULL);
